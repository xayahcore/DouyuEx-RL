    ...
    function handleJsonp(text) {
        ...
        try {
            ...
            for (var gid in dataObj) {
                ...
                var svga = (it.effect && it.effect.effect_icon) ? it.effect.effect_icon : "";

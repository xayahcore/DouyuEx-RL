...
/* --- module: 03_cron.js --- */
function c(){(async()=>{Qt(),setInterval(Qt,35e3)})(),Kn(),setInterval(Kn,3e5),setInterval(()=>{var e=document.querySelector(".ClosingRecommend .dy-ModalRadius-close-x");e&&e.click()},1e3)}

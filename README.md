...
- **[v2026.09.14.01]** - **三级悬浮控制台交互升维与零阻碍物理锚定**：脱离聊天框挂载至 body 实现 0px 像素级精准居中锚定；击穿 display:none 样式死锁；按键上方 18px 隐形连桥；二级 Dock 等比放大 150% 并常驻保活；一键续牌与同屏播放统一 MIUIX 模态化；核心拦截层 100% 守恒。
